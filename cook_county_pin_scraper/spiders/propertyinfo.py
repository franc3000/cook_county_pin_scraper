...
class PropertyinfoSpider(CSVFeedSpider):
    ...
    start_urls = (
        'http://www.chicagocityscape.com/propertytaxes/pins_lists/1-500k.txt',
        #'http://www.chicagocityscape.com/propertytaxes/pins_lists/501k-1000k.txt',
        #'http://www.chicagocityscape.com/propertytaxes/pins_lists/1001k-1500k.txt',
        #'http://www.chicagocityscape.com/propertytaxes/pins_lists/1501k-2000k.txt',
    )
    ...
    def parse_pin(self, response):
        ...
        property_class_description = self.extract_with_prefix(response, 'msgPropertyClassDescription')
        if property_class_description:
            property_class_description = self.extract_with_prefix(response, 'msgPropertyClassDescription').split(' - ')[1]
        else:
